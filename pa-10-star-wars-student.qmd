...
> First line uses base R, second line uses purrr to select the different titles.
...
> The first line uses map to pull starships, then uses map_dbl to count how many there are. The second line uses map_dbl and includes the data and function within. The third line uses pipes to do what the second line did.
...
Now, let's make a plot examining how often hyperdrive ships appear in each episode. Fill in the blanks with appropriate functions.
...
> As ships increase, total hyperdrive ships increase.
...
```
=======
>>>>>>> dc88eac767a3b781c67f5771eb2c953a12d6b17b
---
title: "PA 10: Exploring the Star Wars Universe"
author: "Instructions"
format: 
...
> The two codes do the same thing. Pluck is from the purrr package and the brackets are base R.
...
> All codes utilize purrr package. The first one grabs starships and then the number in two different functions. The second one selects the list, then uses the length function to calculate how many there are. The last just pipes what the second function does.
...
<<<<<<< HEAD
=======
>>>>>>> 863093c1b4c82f8665fa7b053afd7fa55728e550
>>>>>>> dc88eac767a3b781c67f5771eb2c953a12d6b17b
